...
TEST(MonotonicQueueUsingStacks, InitialSetup) {
    // Arrange.
    monotonic_queue_using_stacks<int> mq;
...
TEST(MonotonicQueueUsingStacks, PushSingleElement) {
    // Arrange.
    int value = 5;
    monotonic_queue_using_stacks<int> mq;
...
TEST(MonotonicQueueUsingStacks, PushMultipleElements) {
    // Arrange.
...
TEST(MonotonicQueueUsingStacks, PopSingleElement) {
    // Arrange.
    int value = 5;
    monotonic_queue_using_stacks<int> mq;
...
TEST(MonotonicQueueUsingStacks, PopMultipleElements) {
    // Arrange.
...
TEST(MonotonicQueueUsingStacks, GetMaxAndMinValues) {
    // Arrange.
...
TEST(MonotonicQueueUsingStacks, GetMaxAndMinValues_NonIncreasingElements) {
    // Arrange.
...
TEST(MonotonicQueueUsingStacks, GetMaxAndMinValues_NonDecreasingElements) {
    // Arrange.
